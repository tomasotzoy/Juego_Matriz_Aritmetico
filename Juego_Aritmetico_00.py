...
def matriz3x3_5_j2():
    btn_1= Button(ventana, text="X",bg="grey",font=("Arial Bold",15),command=clic1)
    btn_1.grid(column=3,row=18)
...
def cambios():
    ...
    btn_siguiente2=Button(ventana, text = "Siguienete turno" ,bg="white",fg="black", command= verifica5_3x3)
    btn_siguiente2.grid(column=8,row=26)
...
text_indicador= Entry(ventana, width=20 )
text_indicador.grid(column=8,row=26)
...
btn_siguiente1=Button(ventana, text = "Siguienete turno" ,bg="white",fg="black", command=cambios)
btn_siguiente1.grid(column=8,row=28)
